#!/usr/bin/env node
/**
 * Capture Settings → Agent with Browser = Codex (CLI warning copy).
 * Prerequisites: npm run build && npm run seed:demo
 *   STORY_STUDIO_MOCK_RUNS=1 xvfb-run -a node scripts/capture-codex-chrome-warning.mjs
 */
...
async function main() {
  ...
  await shot(app, "codex-chrome-settings-warning");
